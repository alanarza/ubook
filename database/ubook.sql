...
--
-- Servidor: localhost
-- Tiempo de generación: 03-12-2015 a las 13:07:28
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `descripcion` varchar(500) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Sobre mi..',
...
INSERT INTO `users` (`id`, `rol_id`, `name`, `nombre`, `apellido`, `descripcion`, `foto`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 4, 'Alancitox', 'Eliezer', 'Arza', 'Sobre mi..', 'Alancitox.jpg', 'arzapersonal@gmail.com', '$2y$10$QIi9221CRlykiAbImbi4rOGPDZf0.MP3fOZs/G/e6G148645TPIxS', '6Q3WgTIUVY7YLDFRv84bsoo3bAEcSd0oWwmBOHKztGx6AvIeXpJ7pzVs6B3B', '2015-10-19 03:00:00', '2015-12-03 18:54:39'),
(2, 2, 'martincho', 'Martin', 'Valdez', 'Sobre mi..', 'no-avatar.png', 'martinpentucci@gmail.com', '$2y$10$.vFsj7hWAWKCKYi.YooQkudK7d5pYM5dvvjzmM3Z1u.8noXoyxRsK', 'yQxgP12Tc7NB6Kjv4PobB2Wz5NEOmlS0y0LePqt4dGstXZSEQMUZsfmpLXle', '2015-11-06 22:31:38', '2015-11-06 22:33:10'),
(3, 2, 'Valdesoft', 'Fernando', 'Martin', 'Sobre mi..', 'no-avatar.png', 'fervaldex01@gmail.com', '$2y$10$SGmMUUOowH6njM.c77jJeO1Jjjraw8cuVilj3Qva7Dp9ZFCEuy5OG', 'FuKSy1rFPJc58NHfyDNS1Xmv2pnE0LSzkublACUgHjpxZSVCLU8jpbSTMofS', '2015-11-06 23:08:45', '2015-11-06 23:09:30'),
(11, 1, 'destro', 'martin', 'alpha', 'Sobre mi..', 'no-avatar.png', 'destro@gmail.com', '$2y$10$EDtny1LIX10YU0WE9AcGHekBKyyGSb/eA/Ms0eV99SmKGrFB/49r6', 'Pbq8DqUGkyAo4Mqa6198i1Yyg316A2FpSWewQIcHSmcgstdUvkz4JLOqy5Dk', '2015-11-09 15:55:52', '2015-11-09 17:22:39'),
(12, 1, 'Delver', 'Agustin', 'Riveros', 'Sobre mi..', 'no-avatar.png', 'agusriver@gmail.com', '$2y$10$SdzEWfMBsJZvmq4L4/M/xuA6QVYmYBeELyGV1cbWIWmfkP.y0wp7.', NULL, '2015-11-13 23:36:12', '2015-11-13 23:36:12'),
(13, 1, 'Teemo', 'Alfredo', 'Costa', 'Sobre mi..', 'no-avatar.png', 'temoalfredo@gmail.com', '$2y$10$gR8cuKBF./SQvW26Vr2VmeM20WinDNt/w3mKDhSKO6N5.bXaq.ZQS', '4MIbYCttR78XMDe8SOocNW7TXocj2jvLaOJJ3KrUk5COWgkjrLcKDRhGyXHU', '2015-11-20 18:42:05', '2015-11-20 18:44:27'),
(14, 1, 'luis', 'luis', 'alberto', 'Sobre mi..', 'luis.jpg', 'lualberto@gmail.com', '$2y$10$H0HFivQL1LatiFNx.XmUq.3HqL4yWNsuP5Jf.cbZ9mjVvAuxx66kG', 'cC7ZuKBIQjMnAFKYcOAaUkQT9yq3m9YiAUHHAjEweI97VZ6KSQD25x2mfX0P', '2015-11-23 18:12:52', '2015-11-23 18:27:45');
